                           ...
                           Int_t filtBit = 4)
{
  ...
  AliAnalysisTaskSE* taskpid = reinterpret_cast<AliAnalysisTaskSE*>(gInterpreter->ProcessLine(Form(".x %s(%d,%d)", gSystem->ExpandPathName("$ALICE_ROOT/ANALYSIS/macros/AddTaskPIDResponse.C"), kFALSE, kTRUE)));
